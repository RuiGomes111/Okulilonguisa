...
export default function MenuPrincipal() {
  return (
    ...
    >
      ...
      <Image src="/icon.png" alt="Umbundu Logo" width={180} height={90} />
      <motion.div
      ...
      >
        ...
        <Link
          href="../comojogar"
          className="w-76 bg-blue-600 hover:bg-blue-300 text-white text-lg font-semibold py-3 rounded-2xl transition duration-500 hover:scale-105"
        >
          🎮 Como Jogar
        </Link>
      </motion.div>
